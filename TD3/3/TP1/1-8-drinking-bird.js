...
function createBody() {
	...
	var body = new THREE.Mesh(new THREE.CylinderGeometry(12, 12, 390, 32), cylinderMaterial);
	body.position.x = 0;
	body.position.y = 390 + 4;
	body.position.z = 0;
	scene.add(body);
	var sphere_body = new THREE.Mesh(new THREE.SphereGeometry(58, 32, 16), sphereMaterial);
	sphere_body.position.x = 0;
	sphere_body.position.y = 160;
	sphere_body.position.z = 0;
	scene.add(sphere_body);
...
function createHead() {
	var sphereMaterial = new THREE.MeshLambertMaterial( { color: 0xA00000 } );
	var cylinderMaterial = new THREE.MeshLambertMaterial( { color: 0x0000D0 } );
	var head = new THREE.Mesh(new THREE.SphereGeometry(52, 32, 16), sphereMaterial);
	head.position.x = 0;
	head.position.y = 550;
	head.position.z = 0;
	scene.add(head);
	var hat_top = new THREE.Mesh(new THREE.CylinderGeometry(40, 40, 70, 32), cylinderMaterial);
	hat_top.position.x = 0;
	hat_top.position.y = 600;
	hat_top.position.z = 0;
	scene.add(hat_top);
	var hat_bot = new THREE.Mesh(new THREE.CylinderGeometry(71, 71, 10, 32), cylinderMaterial);
	hat_bot.position.x = 0;
	hat_bot.position.y = 590;
	hat_bot.position.z = 0;
	scene.add(hat_bot);
